...
class OferteResourceIT {
    ...
    private static final Double DEFAULT_SUMA_PLATA = 0D;
    private static final Double UPDATED_SUMA_PLATA = 1D;
    ...
    void checkCodOfertaIsRequired() throws Exception {
        int databaseSizeBeforeTest = oferteRepository.findAll().size();
        // set the field null
        oferte.setCodOferta(null);

        // Create the Oferte, which fails.
        OferteDTO oferteDTO = oferteMapper.toDto(oferte);
        ...
        List<Oferte> oferteList = oferteRepository.findAll();
        assertThat(oferteList).hasSize(databaseSizeBeforeTest);
    }
    ...
    void getAllOfertes() throws Exception {
        ...
        restOferteMockMvc
            ...
            .andExpect(jsonPath("$.[*].sumaPlata").value(hasItem(DEFAULT_SUMA_PLATA.doubleValue())))
    ...
    void getOferte() throws Exception {
        ...
        restOferteMockMvc
            ...
            .andExpect(jsonPath("$.sumaPlata").value(DEFAULT_SUMA_PLATA.doubleValue()))
