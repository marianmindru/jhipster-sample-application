...
class TranzactiiResourceIT {
    ...
    private static final Instant DEFAULT_DATA_PLATA = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_DATA_PLATA = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    void partialUpdateTranzactiiWithPatch() throws Exception {
        ...
        partialUpdatedTranzactii.numarPolita(UPDATED_NUMAR_POLITA).seriePolita(UPDATED_SERIE_POLITA).sumaPlatita(UPDATED_SUMA_PLATITA);
