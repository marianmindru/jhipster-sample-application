...
public class Tranzactii implements Serializable {
    ...
    public Tranzactii o(Oferte oferte) {
        this.setO(oferte);
        return this;
    }

    public void setO(Oferte oferte) {
        this.o = oferte;
    }
    ...
    public Tranzactii p(Polite polite) {
        this.setP(polite);
        return this;
    }

    public void setP(Polite polite) {
        this.p = polite;
    }
    ...
    public Tranzactii u(Users users) {
        this.setU(users);
        return this;
    }
