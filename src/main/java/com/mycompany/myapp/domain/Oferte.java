...
public class Oferte implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties(value = { "os", "ps", "ts" }, allowSetters = true)
    private Users u;

    @JsonIgnoreProperties(value = { "o", "p", "u" }, allowSetters = true)
    @OneToOne(mappedBy = "o")
    private Tranzactii t;
    ...
    public Oferte u(Users users) {
        this.setU(users);
        return this;
    }

    public void setU(Users users) {
        this.u = users;
    }

    public Tranzactii getT() {
        return this.t;
    }

    public Oferte t(Tranzactii tranzactii) {
        this.setT(tranzactii);
        return this;
    }

    public void setT(Tranzactii tranzactii) {
        if (this.t != null) {
            this.t.setO(null);
        }
        if (tranzactii != null) {
            tranzactii.setO(this);
        }
        this.t = tranzactii;
    }
