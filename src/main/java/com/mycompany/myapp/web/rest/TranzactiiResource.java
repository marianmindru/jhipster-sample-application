...
public class TranzactiiResource {
    ...
    public ResponseEntity<List<TranzactiiDTO>> getAllTranzactiis(Pageable pageable) {
        log.debug("REST request to get a page of Tranzactiis");
        Page<TranzactiiDTO> page = tranzactiiService.findAll(pageable);
