...
public class OferteResource {
     ...
     */
    @PostMapping("/ofertes")
    public ResponseEntity<OferteDTO> createOferte(@Valid @RequestBody OferteDTO oferteDTO) throws URISyntaxException {
    ...
    public ResponseEntity<OferteDTO> updateOferte(
        ...
        @Valid @RequestBody OferteDTO oferteDTO
    ...
    public ResponseEntity<OferteDTO> partialUpdateOferte(
        @PathVariable(value = "id", required = false) final Long id,
        @NotNull @RequestBody OferteDTO oferteDTO
    ) throws URISyntaxException {
     ...
     */
    @GetMapping("/ofertes")
    public List<OferteDTO> getAllOfertes() {
